...
//
//func (h *tcpTransportClient) Send(m *Message) error {
...
//	if h.tt.opts.Timeout > time.Duration(0) {
...
//}
//
//func (h *tcpTransportClient) Recv(m *Message) error {
//	if m == nil {
...
//}
//
//func (h *tcpTransportClient) Close() error {
//	err := h.conn.Close()
//	h.once.Do(func() {
//		h.Lock()
//		h.buff.Reset(nil)
...
func (h *tcpTransportSocket) Recv(m *Message) error {
	if m == nil {
		return errors.New("message passed in is nil")
	}
...
func (h *tcpTransportSocket) Send(m *Message) error {
...
func (h *tcpTransportSocket) error(m *Message) error {
	b := bytes.NewBuffer(m.Body)
	defer b.Reset()
	rsp := &http.Response{
		Header:        make(http.Header),
...
func (h *tcpTransportSocket) Close() error {
	err := h.conn.Close()
	h.once.Do(func() {
		h.Lock()
		h.buff.Reset(nil)
...
func (h *tcpTransportListener) Addr() string {
	return h.listener.Addr().String()
}

func (h *tcpTransportListener) Close() error {
	return h.listener.Close()
}

func (h *tcpTransportListener) Accept(fn func(Socket)) error {
...
func (h *tcpTransport) Listen(addr string, opts ...ListenOption) (Listener, error) {
...
func (h *tcpTransport) Init(opts ...Option) error {
	for _, o := range opts {
		o(&h.opts)
	}
	return nil
...
func (h *tcpTransport) Options() Options {
	return h.opts
}
