module github.com/dayan-be/access-service
...
require (
	...
	github.com/dayan-be/golibs v0.0.0-20181110033726-494f10621f02
	github.com/dayan-be/kit v0.0.0-20181110065355-f78a01d204f0
